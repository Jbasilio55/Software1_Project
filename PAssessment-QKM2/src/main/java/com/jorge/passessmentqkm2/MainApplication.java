 ...
 *
 * FUTURE ENHANCEMENT: Gather data from external API, instead of using test data.
 *
...
public class MainApplication extends Application {
    ...
    /**
     * RUNTIME ERROR: can throw a runtime error if there is an issue with redirect location, such as an error with method names or syntax error.
     *
     * This is my start method from fxml loader that holds static data, that I am using as test data.
     * */
    @Override
    public void start(Stage stage) throws IOException {
        ...
        stage.show();
            ...
            System.out.println("Failed to load Fxml loader, please check location of redirect, or next screen source code");
        }
    }
